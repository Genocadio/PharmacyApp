  ...
  #define APPVERSION GetStringFileInfo(AddBackslash(SourcePath) + "..\build\windows\x64\runner\Release\NexxPharma.exe", "ProductVersion")
  #if APPVERSION == ""
...
[Files]
; Copy all build output into the app directory
